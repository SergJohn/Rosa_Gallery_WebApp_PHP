<?php
    ...
    include('../css/arts.css');

    $login = $_SESSION['login_user'];

    //if(isset($_POST['searchType'])){

        //$name = mysqli_real_escape_string($connection, $_POST['typeName']);
            
        $sql = "SELECT * FROM mario_2018358.likes_favorites inner join mario_2018358.items on items_iditems = iditems inner join mario_2018358.artists on artists_idartists = idartists WHERE customers_idcustomers = '$login'";
                                ...
                                <div class='inner_container row'>
                                    ...
                                    <div class='paint row'>
                                        ...
                                        <div class='description col-sm'>
                                                ...
                                                <a name='like' id='like' href='insert-favorite.php?user=$login&artid=$row[iditems]'>

<?php
    ...
    $name = mysqli_real_escape_string($connection, $_POST['titleName']);
        
    $sql = "SELECT * FROM mario_2018358.items inner join mario_2018358.artists on items.artists_idartists = artists.idartists WHERE items.i_name like '%$name%'";

<?php
    ...
    $name = mysqli_real_escape_string($connection, $_POST['artistName']);
        
    $sql = "SELECT * FROM mario_2018358.items inner join mario_2018358.artists on items.artists_idartists = artists.idartists WHERE art_name like '%$name%'";
            ...
            <?php
                ...
                if($result){
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        // Making everything comes dinamically
